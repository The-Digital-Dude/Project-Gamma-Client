          ...
          >
            <div className="cards-grid">
              <div className="feature-card">
                ...
                <p>
                  Ensure your property meets all Victorian smoke alarm
                  requirements with thorough, legally compliant inspections.
                </p>
              </div>
              <div className="feature-card">
                <div
                ...
                <p>
                  All checks are completed by qualified professionals who follow
              ...
              <div className="feature-card">
                ...
                <p>
                  Receive detailed reports and compliance certificates after
                  every inspection—for peace of mind and proof of compliance.
                </p>
              </div>
              <div className="feature-card">
                <div
                ...
                <p>
                  Every job is protected with dual insurance coverage to
              ...
              <div className="feature-card">
                ...
                <p>
                  We offer the best rates in the market—guaranteed—without
              ...
              <div className="feature-card">
                ...
                <p>
                  If alarms need replacing or batteries require changing, we
                  handle it on the spot or coordinate fast follow-up service.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="cards-grid">
              <div className="feature-card">
                ...
                <p>
                  Manage smoke alarm inspections across multiple properties from
              ...
              <div className="feature-card">
                ...
                <p>
                  Seamlessly integrates with leading software like PropertyMe
                  and Property Tree for efficient workflows.
                </p>
              </div>
              <div className="feature-card">
                <div
                ...
                <p>
                  Our system automatically schedules recurring checks and sends
                  reminders, keeping your team on track.
                </p>
              </div>
              <div className="feature-card">
                <div
                ...
                <p>
                  Quickly access reports and certificates for any property, at
                  any time, through your manager dashboard.
                </p>
              </div>
              <div className="feature-card">
                <div
                ...
                <p>
                  Our technicians are trained to conduct checks efficiently and
                  respectfully in occupied properties.
                </p>
              </div>
              <div className="feature-card">
                <div
                ...
                <p>
                  Faulty alarms? We coordinate immediate replacements or repairs
                  through our trusted supplier network.
                </p>
              </div>
            </div>
          </div>
